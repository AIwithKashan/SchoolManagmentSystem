...
export default function EditAssignmentClient({
  ...
  const handleMockUpload = () => {
    ...
    setTimeout(() => {
      ...
      const mockUrl =
        "/attachments/assignment_template_" +
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      toast.error(err.message || "An error occurred while updating the assignment.");
    } finally {
      setIsSaving(false);
    }
  };
      ...
      <Card className="border border-white/[0.06] bg-gray-900/60 backdrop-blur-xl rounded-xl">
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSave} className="space-y-5">
            ...
            {/* Read-only Class & Subject fields */}
            ...
            <div className="flex items-center gap-3 pt-2 border-t border-white/[0.04]">
              ...
              <label
                htmlFor="isActive"
                className="text-xs font-semibold text-gray-300 cursor-pointer"
              >
