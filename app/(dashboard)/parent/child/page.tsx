...
import ParentChildProgressClient from "./ParentChildProgressClient";
...
export default async function ChildProgressPage({ searchParams }: PageProps) {
  ...
  // 3. Query all subjects in school database
